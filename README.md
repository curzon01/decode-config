...
<!-- markdownlint-disable MD033 -->
[![master](https://img.shields.io/badge/master-v15.2.0.0-blue.svg)](https://github.com/tasmota/decode-config/tree/master)
...
<!-- markdownlint-disable MD033 -->
[![development version](https://img.shields.io/badge/development-v15.2.0.2-blue.svg)](https://github.com/tasmota/decode-config/tree/development)
...
This will create a file like `Config_Tasmota_15.2.json` (the part `Tasmota` and `15.2` will choosen related to your device configuration).
...
* `Config_Tasmota_15.2.json` using JSON format
...
To restore the previously save backup file `Config_Tasmota_15.2.json` to device `tasmota-4281` use:

```bash
decode-config -c my.conf -s tasmota-4281 --restore-file Config_Tasmota_15.2
```
